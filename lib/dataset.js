...
var FIELDS = exports.FIELDS = [
    ...
    'GSCsetting',
    'GSCpaySchedule',
    // InSiteVisitZone - Boolean
    // Does the facility fall within ESD geographic boundary for site visits
    'InSiteVisitZoneZone',
    'id'
];
...
/**
 * CSV file that only contains records that are within a certain 
 * geographic boundary that ESD is interested in.
 */
var InZoneDataset = exports.InZoneDataset = function() {};
util.inherits(InZoneDataset, EarlyChildhoodDataset);
_.extend(InZoneDataset.prototype, {
  fields: [
    'LicenseNumber',
    'InSiteVisitZone'
  ],
  ...
  crosswalk: {
    LicenseNumber: 1,
    InSiteVisitZone: function(row) {
      // This will be true for every item in this particular dataset.
      return true;
    },
  },
